...
function LoadingScreen() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AnimatePresence, { children: isLoading && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
		initial: { opacity: 1 },
		exit: { opacity: 0 },
		transition: {
			duration: .6,
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, { style: {
								position: "absolute",
								top: 0,
								left: 0,
								height: "100%",
...
function RootComponent() {
	...
	useSmoothScroll();
	const [isFirstVisit, setIsFirstVisit] = (0, import_react.useState)(() => {
		if (typeof window !== "undefined") return !sessionStorage.getItem("kor-loaded");
		return false;
	});
	(0, import_react.useEffect)(() => {
		if (isFirstVisit) sessionStorage.setItem("kor-loaded", "1");
	}, [isFirstVisit]);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(QueryClientProvider, {
		client: queryClient,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SectionThemeProvider, { children: [
			isFirstVisit && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoadingScreen, {}),
...
var $$splitComponentImporter$3 = () => import("./cv-B4-GZ8Ol.mjs");
